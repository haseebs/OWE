...
directory = "/amigo/LAVIS/johannes/res/fb15k-237z/distmult/"
...
con.set_export_files("/tmp/johannes_villmow/distmult.pt")
#Model parameters will be exported to json files automatically.
con.set_out_files("/tmp/johannes_villmow/distmult.vec.json")
con.init()
