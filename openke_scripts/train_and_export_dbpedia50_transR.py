...
directory = 'res/dbpedia50/transR/'
...
con.set_export_files("/tmp/johannes_villmow/bullshit2.pt")
#Model parameters will be exported to json files automatically.
con.set_out_files("/tmp/johannes_villmow/bullshit2.pt")
con.init()
...
transr_name_map = {
    'ent_embeddings.weight': 'entities.p',
    'rel_embeddings.weight': 'relations.p',
    'transfer_matrix.weight': 'transfers.p'
}
...
for emb_name, filename in transr_name_map.items():
