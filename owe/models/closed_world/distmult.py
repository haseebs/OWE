...
class DistMult(KGCBase):
    ...
    def init_embeddings(self, dataset, emb_dir, entity2id="entity2id.txt",
        ...
        # mid -> int
        external_entity2id = {l.split("\t")[0]: int(l.split("\t")[1].strip()) for l in entity2id_file.open("rt")}
    ...
    def score(self, heads: torch.Tensor, relations: torch.Tensor, tails: torch.Tensor):
        """
